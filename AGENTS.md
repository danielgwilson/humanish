...
This repository is the private incubator for `mimetic-cli`: a generalizable simulation and proof harness extracted from Northstar `ui-sim`, NoBG `ui-sim`, and Image Skill simulation work.

Read this after Daniel's global `AGENTS.md` and before making repo changes.
...
- Do not let Northstar, NoBG, Image Skill, Legion, or Daniel-specific private
...
- Canonical checkout: `~/local_git/mimetic-cli-repo/mimetic-cli/`
- Sibling worktrees: `~/local_git/mimetic-cli-repo/worktrees/<worktree-name>/`
...
```sh
git -C ~/local_git/mimetic-cli-repo/mimetic-cli worktree add ../worktrees/<name> -b <branch>
```
...
- Do not let Northstar, NoBG, or Image Skill nouns leak into core. Product nouns belong in fixtures, examples, migration notes, or adapters.
