...
RUN chown 0:0 /opt/humanish/media/COPYING.v4l2loopback /etc/systemd/system/humanish-media-device.service \
 && chmod 0444 /opt/humanish/media/COPYING.v4l2loopback /etc/systemd/system/humanish-media-device.service \
