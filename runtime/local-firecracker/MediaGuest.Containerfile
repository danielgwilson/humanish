...
RUN chown 0:0 /opt/humanish/media/v4l2loopback.ko /etc/systemd/system/humanish-media-device.service \
 && chmod 0444 /opt/humanish/media/v4l2loopback.ko /etc/systemd/system/humanish-media-device.service \
