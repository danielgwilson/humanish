...
`homun feedback` should let a persona simulation say:
...
commands also require `homun verify` to report
...
| Owner | Meaning |
| --- | --- |
| `harness` | Homun or adapter logic produced invalid evidence or execution. |
