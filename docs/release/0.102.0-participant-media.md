...
cleanup completed. A Mac run demonstrated reciprocal video and spoken clarification,
but changed question wording prevented a clean conversational acceptance. The
updated candidate uses Whisper `base.en`; complete Mac acceptance remains required
