...
| Observer | skeptical-power-user | observer renders completed dry-run, completed `codex-exec` fanout, and blocked Codex TUI bundles | live streaming while actors are still running is deferred | partial |
