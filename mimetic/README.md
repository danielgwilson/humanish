...
- one explicit 1x Codex TUI actor path with fail-fast workspace-trust
  preflight;
- no live Observer follow while actors are still running yet;
...
When Codex TUI trust bootstrap and live follow exist, this config should become
the first full local TUI harness target.
